...
<tbody>
<tr><td>15</td><td>Так</td></tr>
<tr><td>20</td><td>Так</td></tr>
<tr><td>25</td><td>Так</td></tr>
<tr><td>30</td><td>Так</td></tr>
<tr><td>35</td><td>Ні (1.Ч)</td></tr>
</tbody>
</table>

Результати нижче були отримані до вдосконалення моделі
![Залежність енергії за кожну з'їдену вівцю від кількості вовків](wolf-gain-from-food.png)

Результати отримані після вдосконалення моделі
![Залежність енергії за кожну з'їдену вівцю від кількості вовків](wolf-gain-from-food_2.png)

До змін: вовки виживали у 4 з 5 випадків з стабільними популяціями, а після змін: вовки вимирають у 4 з 5 випадків. Модель демонструє, що при відсутності зграйної поведінки та при наявності ефективного уникнення хижаків, хижаки приречені на вимирання.
