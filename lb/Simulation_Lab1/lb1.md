...
Модель імітує динаміку взаємодії двох типів агентів — хижаків (вовків) та їхніх жертв (овець) — у межах замкнутого середовища, де відтворюються основні процеси екологічної системи «хижак–жертва». Кожен агент діє за певними правилами: вівці рухаються середовищем у пошуках їжі (трави) та розмножуються, тоді як вовки полюють на овець для виживання. Якщо вовки не знаходять їжі, вони гинуть від голоду. Таким чином, модель демонструє, як баланс між хижаками, жертвами та ресурсами визначає стабільність або нестабільність екосистеми в часі. Зокрема, модель дозволяє дослідити, за яких умов популяції зберігаються, коливаються або вимертають, відображаючи природні механізми регуляції чисельності видів.
