...
Важливо **обирати для роботи ті моделі, які поки що ніхто не розглядав**. Узгоджений вибір буде зафіксовано у всім доступній таблиці (окремому листі таблиці з даними щодо успішності).
...
<!-- Максимальна оцінка буде зменшуватись по мірі попиту на завдання. Була 40 раніше. Теперь 30. -->
...
<!-- Максимальна оцінка буде зменшуватись по мірі попиту на завдання. Була 60 раніше. Теперь 50. -->
